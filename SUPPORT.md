...
Thanks for using CatastRoNav! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/rOpenSpain/CatastRoNav/issues/new).
...
requests](https://github.com/rOpenSpain/CatastRoNav/issues) to make sure
