# Contributing to CatastRoNav

This outlines how to propose a change to CatastRoNav. For a detailed discussion
on contributing to this package, please see the [development contributing
...
- Fork the package and clone onto your computer. If you haven't done this
  ...
  `usethis::create_from_github("rOpenSpain/CatastRoNav", fork = TRUE)`.
...
Please note that the CatastRoNav project is released with a [Contributor Code of
