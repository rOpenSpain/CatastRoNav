...
This outlines how to propose a change to CatastRoNav. For a detailed
...
Please note that the CatastRoNav project is released with a [Contributor
Code of
Conduct](https://ropenspain.github.io/CatastRoNav/CODE_OF_CONDUCT.md).
